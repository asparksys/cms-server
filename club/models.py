...
class BranchClub(models.Model):
    ...
    club_id = models.CharField(max_length=255, blank=True, default=None, null=True)
    motto = models.CharField(max_length=255, null=False, blank=False, default=None)
    ...
    # social media
    website = models.URLField(max_length=2048, default="https://asparksys.com", blank=True)
    instagram = models.URLField(
        max_length=2048,
        default="hittps://instagram.com/asparksystems",
        blank=True,
    )
    facebook = models.URLField(max_length=2048, default="https://facebook.com/aspaksys", blank=True)
    twitter = models.URLField(max_length=2048, default="https://twitter.com/asparksys", blank=True)
