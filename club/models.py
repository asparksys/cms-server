...
class BranchClub(models.Model):
    ...
    instagram = models.URLField(
        max_length=2048, default='hittps://instagram.com/asparksystems', blank=True)
    ...
    logo = models.URLField(
        max_length=2048, default="https://4m4you.com/wp-content/uploads/2020/06/logo-placeholder.png")
